...
public class Fourth {
    ...
    public static void BMI(String weight, String height){
        ...
        if (mass < 18.5)
            System.out.println("Äàííûé âåñ = "+massfin+" ÿâëÿåòñÿ íåäîñòàòî÷íûì");
        else if (mass >= 25)
            System.out.println("Äàííûé âåñ = "+massfin+" ÿâëÿåòñÿ èçáûòî÷íûì");
        else
            System.out.println("Äàííûé âåñ = "+massfin+" ÿâëÿåòñÿ íîðìàëüíûì");
    }
    ...
    public static void rhyme (String str1, String str2){
        ...
        for (int i = 0; i < last2.length(); i++)
            if ("AEIOUY".contains(last2.substring(i, i+1)))
                vow2 += last2.charAt(i);
        if (vow1.equals(vow2))
                    System.out.println("Ñòðîêè ðèôìóþòñÿ");
                else
                    System.out.println("Ñòðîêè íå ðèôìóþòñÿ");
